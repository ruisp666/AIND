        ...
        for a in self.all_actions:  
            ...
            if a_candidate:
                for node in a_candidate.prenodes:
                    ...
                    a_candidate.parents.add(node)
                    for node3 in self.s_levels[level]:
                        if node3 in a_candidate.prenodes:
                            node3.children.add(a_candidate)
                    #node.children.add(a_candidate)
...
#               else:
#                   node2.show()
               if node2.symbol in a.action.effect_add:
                   #node2.show()
                   ...
                   for b in self.a_levels[level-1]:
                       if node2 in b.effnodes:
                           node2.parents.add(b)
               if node2.symbol in a.action.effect_rem :
                   #print(node2.symbol.op,  node2.is_pos)
                   #node2.show()
                   a.children.add(node2)
                   for b in self.a_levels[level-1]:
                       if node2 in b.effnodes:
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        """
#        for literal in node_a1.action.precond_pos:
#            if literal in (node_a2.action.precond_pos or node_a2.action.precond_neg):
#                return True
#        for literal in node_a2.action.precond_pos:
#            if literal in (node_a1.action.precond_pos or node_a1.action.precond_neg):
#                return True
#        for literal in node_a1.action.precond_neg:
#           if literal in (node_a2.action.precond_pos or node_a2.action.precond_neg):
#                return True
#        for literal in node_a2.action.precond_neg:
#            if literal in (node_a1.action.precond_pos or node_a1.action.precond_neg):
#                return True
