...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        def fly_actions():
            ...
            :return: list of Action objects
            """
            #This can be done in similar way to unload_actions
            flys = []
    ...
    def actions(self, state: str) -> list:
        ...
        # For all the actions, we add if all the preconditions are satisfied.
...
#                      b=False         
    ...
    def result(self, state: str, action: Action):
        ...
        state_decoded=decode_state(state,self.state_map)
        # Add all the fluents present in effect_add to new_state.pos, and 
        ...
        #Add the negative effects of a to the neg part of the state literal
        # and remove them from the positive part
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        #Ignorning preconditions, we can obtain the goal by applying 
        #each of the actions that result on one literal from the  of the goal.
        #After obtaining the fluent representation, we sum over all 
        #the goal literals that are not already in the state.
