...
class MinimaxPlayer(IsolationPlayer):
    ...
    in the same way as in  the mini-project. We change syntax in order to make 
    them class methods.
    """
...
#            return 1
#        logging.info("Searching at level %d..." %self.move_count )
#        v=float("inf")
#        if game.move_count==depth-1:
#            logging.info("minimizing over last depth..." )
#            v, move = min([(self.score(game.forecast_move(m), self), m) 
#                    for m in game.legal_moves()])
#        else:
#            v, move = min([(self.max_value(game.forecast_move(m), self), m) 
#                    for m in game.legal_moves()])
#        return v         
#    
#
...
#                    for m in game.legal_moves()])
#        else:
#            v, move = max([(self.min_value(game.forecast_move(m), self), m) 
#                    for m in game.legal_moves()])
#        return v       
            
#            for move in game.get_legal_moves():
#                v=max(v, self.score(game.forecast_move(move)))
#        else:
#            for move in game.get_legal_moves():
...
#        
#        start_counter=self.count_moves
#        while i<=depth:
#            for move in game.get_legal_moves():
#                vmin= self.score(game.forecast_move(move))
#                if v <vmin:
#                    v=vmin
#                    move_found=move
#        return move_found  
